...
FILE = "settings/hp_settings/dog_stats.bin"
OPTIONS = [
...
def process(options: dict) -> None:
  ...
  base_track = 25.0
  base_retrieve = 25.0
  new_passive_cell = mods.find_closest_lookup(base_passive * xp, FILE)
  new_sit_cell = mods.find_closest_lookup(base_sit * xp, FILE)
  new_heel_cell = mods.find_closest_lookup(base_heel * xp, FILE)
  new_detect_cell = mods.find_closest_lookup(base_detect * xp, FILE)
  new_track_cell = mods.find_closest_lookup(base_track * xp, FILE)
  new_retrieve_cell = mods.find_closest_lookup(base_retrieve * xp, FILE)
  ...
  for update in updates:
    mods.update_file_at_offset(FILE, update["offset"], update["value"])
